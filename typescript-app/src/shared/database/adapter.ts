...
export interface DatabaseAdapter {
   ...
   */
  getAll<T extends TableName>(tableName: T, orderBy?: string): Promise<DatabaseSchema[T][]>;
   ...
   */
  getById<T extends TableName>(tableName: T, id: string): Promise<DatabaseSchema[T] | null>;
   ...
   */
  insert<T extends TableName>(tableName: T, data: Partial<DatabaseSchema[T]>): Promise<string>;
   ...
   * @returns Number of affected rows
   */
  update<T extends TableName>(tableName: T, id: string, data: Partial<DatabaseSchema[T]>): Promise<number>;
   ...
   * @returns Number of affected rows
   */
  delete<T extends TableName>(tableName: T, id: string): Promise<number>;
   ...
   */
  findBy<T extends TableName>(tableName: T, field: string, value: DbValue): Promise<DatabaseSchema[T][]>;
}